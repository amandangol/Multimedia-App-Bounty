...
export default function App() {
  ...
  const handleShare = (file) => {
    ...
    if (navigator.share) {
      ...
      const platforms = [
        ...
        { name: 'Instagram', url: `https://www.instagram.com/share?url=${shareUrl}&title=${encodeURIComponent(shareText)}` },
  ...
  const handleSelectedFile = (file) => {
    ...
    setSearchQuery(file.name); // Set the search query to the selected file name
  };
